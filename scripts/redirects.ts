...
[[redirects]]
  from = "${base}pdf"
  to = "https://github.com/nyxb/talks/blob/main/${dir}/${pdfFile}?raw=true"
  status = 302
...
[[redirects]]
  from = "${base}src"
  to = "https://github.com/nyxb/talks/tree/main/${dir}"
  status = 302`)

      parts.push(`
[[redirects]]
  from = "${dir}"
  to = "https://talks.nyxb.nexus{base}"
  status = 301
